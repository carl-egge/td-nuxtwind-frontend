    ...
    <footer class="flex flex-col items-center bg-text text-center text-white"> <!-- bg-neutral-900 -->
        <div class="container px-6 pt-6">
            ...
            <div class="mb-8 flex justify-center">
                ...
                <!-- <Icon name="material-symbols:horizontal-rule-rounded" class="h-6 w-6" aria-hidden="true" /> -->
                <!-- <Icon name="material-symbols:more-horiz" class="h-6 w-6" aria-hidden="true" /> -->
            </div>
                        ...
                        <div class="flex-auto">
                            <ul class="mb-0 list-none md:text-left">
                                ...
                                <li class="lg:my-1">
                                    ...
                                    <a href="mailto:info@theaterdeck.de">
                                        info@theaterdeck.de
                                    </a>
                                </li>
                                <li>
                        ...
                        <div class="flex-auto">
                            <ul class="mb-0 list-none md:text-left">
                                <li>
                                    ...
                                    <Icon name="material-symbols:arrow-right-rounded" aria-hidden="true" />10:00 bis 12:00
                                    Uhr
                                </li>
                                <li class="lg:my-1">
        ...
        <!-- Copyright section -->
        <div class="w-full p-4" style="background-color: rgba(0, 0, 0, 0.2)">
            <div class="flex md:justify-between flex-col-reverse md:flex-row">
                ...
                <div class="flex-1 text-center md:text-right my-4 md:my-0">
                    <a href="https://www.facebook.com/theaterdeck" target="_blank" class="mx-3">
                        <Icon name="mdi:facebook" class="text-2xl hover:text-gray-400" />
                    </a>
                    <a href="https://www.instagram.com/theaterdeck/" target="_blank" class="mx-3">
                        <Icon name="mdi:instagram" class="text-2xl hover:text-gray-400" />
                    </a>
                </div>
            </div>
        </div>
