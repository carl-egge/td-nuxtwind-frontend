<template>
    <div>
        ...
        <main>
            ...
            <hr class="my-2 w-6 mx-auto">
            <section id="rights-data-acquisition" class="my-8">
                <h2>
                    Datenerfassung auf unserer Website
                </h2>
                <UAccordion color="primary" variant="solid" size="md" :ui="{ item: { padding: 'pl-2' } }"
                    :items="dataAcquistion" />
            </section>
            <hr class="my-2 w-6 mx-auto">
...
<script setup>
/**
 * PAGE: datenschutz.vue
 *
 * Page for Datenschutzerklärung.
 */
import heroimage from "../assets/images/hero-highkey-petterson.jpg";

const dataAcquistion = [
    {
        id: 0,
        label: 'Wer ist verantwortlich für die Datenerfassung auf dieser Website?',
    ...
    {
        id: 3,
        label: 'Welche Rechte haben Sie bezüglich Ihrer Daten?',
    ...
    },
    {
        ...
        content: 'Beim Besuch unserer Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das geschieht vor allem mit Cookies und mit sogenannten Analyseprogrammen. Die Analyse Ihres Surf-Verhaltens erfolgt in der Regel anonym; das Surf-Verhalten kann nicht zu Ihnen zurückverfolgt werden. Sie können dieser Analyse widersprechen oder sie durch die Nichtbenutzung bestimmter Tools verhindern. Detaillierte Informationen dazu finden Sie in der folgenden Datenschutzerklärung. Sie können dieser Analyse widersprechen. Über die Widerspruchsmöglichkeiten werden wir Sie in dieser Datenschutzerklärung informieren.'
    },
]
...
const generalRemarks = [
    {
        ...
        content: 'Der Verantwortliche im Sinne der Datenschutzgrundverordnung (im Folgenden: „DSGVO“) und anderer nationaler Datenschutzgesetze sowie sonstiger datenschutzrechtlicher Bestimmungen ist: THEATERDECK HAMBURG - Niklas Heinecke | Maurienstr. 19 | 22305 Hamburg Tel. (+49) 40 632 13 22 - E-Mail: info@theaterdeck.de'
    },
    {
        id: 1,
        label: 'II. Allgemeines zur Datenverarbeitung',
        content: 'Datenschutz hat für das THEATERDECK HAMBURG einen besonderen Stellenwert. Aus diesem Grund erheben und verwenden wir personenbezogene Daten unserer Nutzer grundsätzlich auch nur, soweit dies zur Bereitstellung einer funktionsfähigen Website sowie unserer Inhalte und Leistungen erforderlich ist. Personenbezogene Daten sind alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person (im Folgenden: „betroffene Person“) beziehen. Die Erhebung und Verwendung personenbezogener Daten unserer Nutzer erfolgt stets im Einklang mit der DSGVO und den geltenden landesspezifischen Datenschutzregeln. Ist die Verarbeitung personenbezogener Daten erforderlich und ist eine solche Verarbeitung nicht durch gesetzliche Vorschriften gestattet, holen wir immer eine Einwilligung der betroffenen Person ein. Eine Weitergabe von persönlichen Daten an Dritte findet grundsätzlich nicht statt. Eine Übermittlung erfolgt nur, wenn Sie ausdrücklich eingewilligt haben (Art. 6 Abs. 1 S. 1 lit. a DSGVO); für die Weitergabe ein berechtigtes Interesse und kein Grund zur Annahme besteht, dass Sie ein überwiegendes schutzwürdiges Interesse an der Nichtweitergabe Ihrer Daten haben (Art. 6 Abs. 1 S. 1 lit. f DSGVO); für die Weitergabe eine gesetzliche Verpflichtung besteht (Art. 6 Abs. 1 S. 1 lit. c DSGVO); oder eine Weitergabe zulässig ist im Rahmen der Erfüllung eines Vertrages mit Ihnen (Art. 6 Abs. 1 S. 1 lit. b DSGVO)'
    },
    {
        id: 2,
        label: 'III. Erhebung und Speicherung personenbezogener Daten beim Besuch der Website',
        content: 'Bei jedem Aufruf unserer Website www.theaterdeck.de werden durch den von Ihnen genutzten Browser automatisiert Informationen an den Server unserer Website übermittelt. Folgende Informationen werden dabei erfasst und bis zur automatischen Löschung gespeichert: 1. IP-Adresse des anfragenden Rechners, 2. Datum und Uhrzeit des Zugriffs, 3. Name und URL der abgerufenen Datei, 4. die Referrer-URL, d.h. die Website, von der aus der Zugriff erfolgte, 5. Informationen über den verwendeten Browsertyp, 6. das Betriebssystem Ihres Rechners, 7. der Name Internet-Service-Providers. Diese Daten werden nur temporär in einem sog. Logfile gespeichert. Nicht hiervon betroffen sind die IP-Adressen des Nutzers oder andere Daten, die die Zuordnung der Daten zu einem Nutzer ermöglichen. Eine Speicherung dieser Daten zusammen mit anderen personenbezogenen Daten des Nutzers findet nicht statt. Bei der Nutzung dieser Daten ziehen wir keinerlei Rückschlüsse auf die betroffene Person. Die Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1 S. 1 lit. f DSGVO. Unser berechtigtes Interesse liegt in der Bereitstellung einer funktionsfähigen Website mit korrekt ausgelieferten Inhalten, in der Optimierung unserer Systeme und darin, Strafverfolgungsbehörden im Falle eines Cyberangriffs die zur Strafverfolgung notwendigen Informationen bereitzustellen. Sobald kein berechtigtes Interesse mehr besteht und keine gesetzliche Aufbewahrungspflicht besteht, werden diese Daten routinemäßig gelöscht. Darüber hinaus nutzen wir Cookies und setzen Analysedienste ein. Nähere Informationen dazu finden Sie unter den Ziffern IV. und V. dieser Datenschutzerklärung.'
    },
    {
        id: 3,
        label: 'IV. Cookies',
        content: 'Auf unserer Website setzen wir Cookies ein. Bei Cookies handelt es sich um kleine Textdateien, die Ihr Browser automatisch erstellt und die auf Ihrem Endgerät gespeichert werden können. Dieser Cookie enthält eine charakteristische Zeichenfolge, die eine eindeutige Identifizierung des Browsers beim erneuten Aufrufen der Website ermöglicht. Dies bedeutet nicht, dass wir dadurch unmittelbar Kenntnis von Ihrer Identität erhalten. Der Einsatz von Cookies dient einerseits dazu, die Nutzung unseres Angebots für Sie angenehmer zu gestalten. Darüber hinaus setzen wir Cookies zur Optimierung der Benutzerfreundlichkeit und unseres Angebots und zur statistischen Erfassung ein. Wir setzen sogenannte Session-Cookies ein, um zu erkennen, dass Sie einzelne Seiten unserer Website bereits besucht haben. Diese Cookies werden nach Verlassen unserer Seite automatisch gelöscht. Darüber hinaus setzen wir temporäre Cookies ein, die für einen bestimmten festgelegten Zeitraum auf Ihrem Endgerät gespeichert werden. Besuchen Sie unsere Seite erneut, wird automatisch erkannt, dass Sie bereits bei uns waren und welche Eingaben und Einstellungen sie getätigt haben, um diese nicht noch einmal eingeben zu müssen. Zu den erhobenen Daten gehören die Häufigkeit von Seitenaufrufen, eingegebene Suchbegriffe und die Inanspruchnahme von Websiten-Funktionen. Der Einsatz von Cookies zur statistischen Erfassung und Auswertung unseres Angebots ist in Ziffer V. genauer beschrieben. Diese Cookies ermöglichen es uns, bei einem erneuten Besuch unserer Seite automatisch zu erkennen, dass Sie bereits bei uns waren. Diese Cookies werden nach einer jeweils definierten Zeit automatisch gelöscht. Die durch Cookies verarbeiteten Daten sind für die genannten Zwecke zur Wahrung unserer berechtigten Interessen sowie der Dritter nach Art. 6 Abs. 1 S. 1 lit. f DSGVO erforderlich. Unser berechtigtes Interesse liegt in der Bereitstellung einer funktionalen und benutzerfreundlichen Website. Die meisten Browser akzeptieren Cookies automatisch. Sie können Ihren Browser jedoch so konfigurieren, dass keine Cookies auf Ihrem Computer gespeichert werden oder stets ein Hinweis erscheint, bevor ein neuer Cookie angelegt wird. Die vollständige Deaktivierung von Cookies kann jedoch dazu führen, dass Sie nicht alle Funktionen unserer Website nutzen können.'
    },
    {
        id: 4,
        label: 'V. Einsatz von Analysediensten',
        content: 'Google Analytics Zum Zwecke der bedarfsgerechten Gestaltung und fortlaufenden Optimierung unserer Seiten nutzen wir Google Analytics, ein Webanalysedienst der Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA (im Folgenden: „Google“) ( https://www.google.de/intl/de/about/). Wir setzen Google Analytics auf Grundlage des Art. 6 Abs. 1 S. 1 lit. f DSGVO ein. Wir wollen damit eine bedarfsgerechte Gestaltung und die fortlaufende Optimierung unserer Website sicherstellen. Zum anderen setzen wir die Tracking-Maßnahmen ein, um die Nutzung unserer Webseite statistisch zu erfassen und zum Zwecke der Optimierung unseres Angebotes für Sie auszuwerten. Diese Interessen sind als berechtigt im Sinne der vorgenannten Vorschrift anzusehen. In diesem Zusammenhang werden pseudonymisierte Nutzungsprofile erstellt und Cookies (siehe unter Ziffer IV.) verwendet. Die durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Website wie 1. Browser-Typ/-Version, 2. verwendetes Betriebssystem, 3. Referrer-URL (die zuvor besuchte Seite), 4. Hostname des zugreifenden Rechners (IP-Adresse), 5. Uhrzeit der Serveranfrage, werden in der Regel an einen Server von Google in den USA übertragen und dort gespeichert. Diese Informationen werden gegebenenfalls an Dritte übertragen, sofern dies gesetzlich vorgeschrieben ist oder soweit Dritte diese Daten im Auftrag verarbeiten. Es wird in keinem Fall die von Ihrem Browser übertragene IP-Adresse mit anderen Daten von Google zusammengeführt. Die IP-Adressen werden anonymisiert, so dass eine Zuordnung nicht möglich ist (IP-Masking). Nur in Ausnahmefällen wird die volle IP-Adresse an einen Server von Google in den USA übertragen und dort gekürzt. In unserem Auftrag wird Google diese Information benutzen, um Ihre Nutzung der Website auszuwerten, um Reports über die Websiten-Aktivitäten zusammenzustellen und um weitere mit der Websiten-Nutzung und der Internetnutzung verbundene Dienstleistungen gegenüber uns zu erbringen. Sie können die Installation der Cookies durch eine entsprechende Einstellung der Browser-Software verhindern; wir weisen jedoch darauf hin, dass in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich genutzt werden können. Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie ein Browser-Add-on herunterladen und installieren ( https://tools.google.com/dlpage/gaoptout?hl=de). Alternativ zum Browser-Add-on, insbesondere bei Browsern auf mobilen Endgeräten, können Sie die Erfassung durch Google Analytics zudem verhindern, indem Sie auf diesen LINK klicken. Es wird ein Opt-out-Cookie gesetzt, sodass zukünftig die Erfassung Ihrer Daten beim Besuch dieser Website verhindert wird. Der Opt-out-Cookie wird auf Ihrem Gerät abgelegt und gilt nur in diesem Browser und nur für unsere Website. Löschen Sie die Cookies in diesem Browser, müssen Sie das Opt-out-Cookie erneut setzen. Weitere Informationen zum Datenschutz im Zusammenhang mit Google Analytics finden Sie etwa in der Google Analytics-Hilfe: https://support.google.com/analytics/answer/6004245?hl=de.'
    },
    {
        id: 5,
...
const agb = [
    {
        ...
        content: 'Geltungsbereich Die allgemeinen Geschäftsbedingungen (nachfolgend AGB) regeln die rechtlichen Beziehungen zwischen dem Theaterdeck Hamburg (nachfolgend Theater) und ihren Besuchern:innen (nachfolgend Kunde). Mit Erwerb einer Eintrittskarte gelten diese Bedingungen als vereinbart.'
    }
]
</script>
